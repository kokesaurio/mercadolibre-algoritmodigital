...
export const INSTRUCCIONES = [
  ...
  'Guía rápida:',
  '- Empezá por `ml_panel` cuando la pregunta es general ("cómo viene el día", "cómo van las tiendas").',
  '  Sin filtro de cuenta, `ml_panel` y `ml_metricas` devuelven el CONSOLIDADO de todas las tiendas',
  '  más el desglose de cada una: no llames una por una para sumarlas vos.',
  '- Si el usuario quiere ver una tienda puntual, resolvé su ID con `ml_cuentas` y pasalo en `cuenta`.',
  '- Si no hay ninguna tienda conectada, o el usuario quiere agregar otra, usá `ml_conectar`.',
